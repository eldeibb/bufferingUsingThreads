...
public class GUI extends javax.swing.JFrame {
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        ...
        try {
            ...
            Buffer buffObj = new Buffer(two);
            Producer producerObj = new Producer(buffObj, one);
            Consumer consumerObj = new Consumer(buffObj, one, three);
            ...
            t = end-start; // -->  Time in ms
            
        } catch (InterruptedException ex) {
            Logger.getLogger(GUI.class.getName()).log(Level.SEVERE, null, ex);
        }
        
        String three = Long.toString(t);
        GUI.jLabel8.setText(three);
